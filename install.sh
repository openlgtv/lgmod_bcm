#!/bin/sh
# OpenLGTV BCM 0.5.0-SVN20120426 installation script v.1.99 by xeros
...
echo "OpenLGTV BCM 0.5.0-SVN20120426 installation script for $platform platform by xeros" | tee -a $log
