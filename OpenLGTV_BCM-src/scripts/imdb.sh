...
do
    ...
    url="http://playon.unixstorm.org/IMDB/movie_beta.php?mode=sheet&backdrop=y&box=dvd&font=tahoma&genres=y&post=y&tagline=y&time=hours${lang}${provider}&name=${name}"
    #echo "URL: $url"
