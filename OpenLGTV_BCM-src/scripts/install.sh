#!/bin/sh
# OpenLGTV BCM 0.5.0-beta1 installation script v.1.95 by xeros
...
echo "" | tee -a $log
date 2>&1 | tee -a $log
echo "OpenLGTV BCM 0.5.0-beta1 installation script for $platform platform by xeros" | tee -a $log
