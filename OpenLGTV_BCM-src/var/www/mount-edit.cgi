			...
			<center>
				...
				<?
					...
					then
					    ...
					    then
						echo -n "<input type=\"button\" id=\"link11\" onKeyPress=\"javascript:window.location='mount-edit.cgi?mount=1';\" onClick=\"javascript:window.location='mount-edit.cgi?mount=1';\" value=\"Mount button: You need to plug USB stick with OpenLGTV_BCM dir first\" style=\"width:600px\" disabled />"
					    else
						echo -n "<input type=\"button\" id=\"link11\" onKeyPress=\"javascript:window.location='mount-edit.cgi?mount=1';\" onClick=\"javascript:window.location='mount-edit.cgi?mount=1';\" value=\"Mount\" style=\"width:100px\" />"
					    fi
					else
					    echo -n "<input type=\"button\" id=\"link11\" onKeyPress=\"javascript:window.location='mount-edit.cgi?mount=1';\" onClick=\"javascript:window.location='mount-edit.cgi?mount=1';\" value=\"Mount button: You need to save first to be able to mount\" style=\"width:600px\" disabled />"
					fi
				    else
					echo -n "<input type=\"button\" id=\"link11\" onKeyPress=\"javascript:window.location='mount-edit.cgi?umount=1';\" onClick=\"javascript:window.location='mount-edit.cgi?umount=1';\" value=\"Unmount\" style=\"width:400px\" />"
				    fi
				?>
			    </div>
			</center>
